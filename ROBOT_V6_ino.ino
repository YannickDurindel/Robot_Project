...
void grab_cup () {
  ...
  Steps2Take_Mcup=-2048*3;
  small_stepper_Mcup.step(Steps2Take_Mcup);  //la courroie se ressère sur le verre
  Steps2Take_Mbras=-2048*0.85;
  small_stepper_Mbras.step(Steps2Take_Mbras);  //le bras le relève de plus que 90°
  delay(2000);                           //attend que les billes se déversent
  Steps2Take_Mbras=2048*0.85;
  small_stepper_Mbras.step(Steps2Take_Mbras);  //le bras se rebaise
  Steps2Take_Mcup=2048*3;
